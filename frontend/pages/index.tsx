...
const Home: NextPage = () => {
  ...
  const contractAddress = "0x3192d4d804345fb3ad9f76f1bea5b0f15d07cccd"
  useEffect(() => {
  ...
  function MintButton() {
      ...
      try{
        await (window as any).ethereum.request({
          ...
          params: [{
            ...
            rpcUrls: ['https://goerli.infura.io/v3/91aa070b63534bb8be906bde81c135d5'],
          }],
        });
        console.log('try');
        setDisabledFlag(true);
    ...
    <div className="bg-black pb-16 flex flex-wrap buttom justify-center">
      ...
      <div className="m-12 lg:m-32 px-12 py-6 lg:pt-8 lg:px-20 border-2 bg-black text-center border-[#FFFFFF] bg-center bg-contain bg-no-repeat">
        <h1 className="text-2xl lg:text-4xl pt-2 lg:pt-4 lg:pb-6 text-white font-['Impact']">謎のゆる画像NFT</h1>
